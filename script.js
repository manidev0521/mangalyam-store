...
const FALLBACK_PRODS = [
  {id:'p1',cats:['all','yellow'],name:'Classic Manjal Thali Kayiru',tamil:'கைவினை முறை மஞ்சள் தாலி கயிறு',brand:'Mangalyam · G. Anandan',type:'Natural Turmeric · Pure Cotton · 24 inch',badge:'BESTSELLER',bc:'m',imgs:['images/product1.png','images/product4.png'],emoji:'🟡',retail:38,ws:12,wsMin:20,rating:4.9,reviews:521,specs:{Material:'Pure Cotton',Length:'24 inches',Dye:'Natural Haldi',Twist:'3-ply',Owner:'G. Anandan',Origin:'Poonamalle, Chennai'}},
  {id:'p2',cats:['all','bulk','wholesale'],name:'Bulk Bundle — 10 pcs',tamil:'10 நூல் தொகுப்பு',brand:'Mangalyam · G. Anandan',type:'Set of 10 · Ready Dispatch · Plastic Packed',badge:'BULK',bc:'g',imgs:['images/product2.png','images/product3.png'],emoji:'📦',retail:370,ws:130,wsMin:1,rating:4.8,reviews:342,specs:{Quantity:'10 pcs',Material:'Pure Cotton',Price:'₹37/pc retail',WSPrice:'₹13/pc wholesale',Dispatch:'Same day',Origin:'Poonamalle, Chennai'}},
  {id:'p3',cats:['all','wholesale'],name:'Wholesale Pack — 50 pcs',tamil:'50 நூல் மொத்த தொகுப்பு',brand:'Mangalyam · G. Anandan',type:'50 pcs · Plastic Sealed · GST Invoice',badge:'WHOLESALE',bc:'m',imgs:['images/product3.png','images/product2.png'],emoji:'🏷️',retail:1900,ws:650,wsMin:1,rating:4.9,reviews:187,specs:{Quantity:'50 pcs',Price:'₹38/pc retail',WSPrice:'₹13/pc wholesale',GST:'Invoice incl.',Dispatch:'Priority 24hrs',Origin:'Poonamalle, Chennai'}},
  {id:'p4',cats:['all','temple'],name:'Temple Grade Premium Kayiru',tamil:'கோவில் தர தாலி கயிறு',brand:'Mangalyam · G. Anandan',type:'Premium Cotton · Double Dyed · 24 inch',badge:'TEMPLE',bc:'m',imgs:['images/product4.png','images/product1.png'],emoji:'🛕',retail:40,ws:15,wsMin:20,rating:5.0,reviews:289,specs:{Material:'Premium Cotton',Length:'24 inches',Dye:'Double Haldi',Grade:'Temple Grade',Owner:'G. Anandan',Origin:'Poonamalle, Chennai'}},
  {id:'p5',cats:['all','wholesale'],name:'Mega Pack — 100 pcs',tamil:'100 நூல் மொத்த விலை',brand:'Mangalyam · G. Anandan',type:'100 pcs · Factory Direct · Best Rate',badge:'BEST VALUE',bc:'g',imgs:['images/product3.png','images/product2.png'],emoji:'🏭',retail:3800,ws:1200,wsMin:1,rating:4.8,reviews:94,specs:{Quantity:'100 pcs',RetailRate:'₹38/pc',WSRate:'₹12/pc',Savings:'₹2,600 saved',Dispatch:'Priority',Origin:'Poonamalle, Chennai'}},
  {id:'p6',cats:['all','yellow'],name:'Short Thali Kayiru — 18 inch',tamil:'குறுகிய தாலி கயிறு',brand:'Mangalyam · G. Anandan',type:'Compact · 18 inch · Natural Dye',badge:'NEW',bc:'g',imgs:['images/product1.png','images/product4.png'],emoji:'✨',retail:35,ws:12,wsMin:20,rating:4.7,reviews:67,specs:{Material:'Pure Cotton',Length:'18 inches',Dye:'Natural Haldi',Twist:'3-ply',Owner:'G. Anandan',Origin:'Poonamalle, Chennai'}},
];
...
function renderGrid(gid, list) {
  ...
  g.innerHTML = list.map(p => {
    ...
    const retailStr = isMulti ? '₹' + p.retail.toLocaleString('en-IN') : '₹' + p.retail;
    ...
    return `<div class="p-card" onclick="openMod('${p.id}')">
      ...
      <div class="p-body">
        ...
        <div class="p-price-block">
          ...
          <div class="p-price-range">Retail: ₹35–₹40/pc · Premium: ₹40/pc</div>
